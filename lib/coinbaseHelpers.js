    ...
    Meteor.methods({
        ...
        BTCHasClearedForPlayer1: function () {
            ...
            if (currentGame == null) {
                ...
                cl('BTCHasClearedForPlayer1() method returns with no value. No updates done');
                return;
            }
            ...
            var intervalId = Meteor.setInterval(function () {
                ...
                client.getAccount(coinbasePressItAccount, function (err, account) {
                    ...
                    account.getTransactions(null, function (err, transactions) {
                        ...
                        transactions.forEach(function (transaction) {
                            ...
                            //    (jsonTransaction['from'] == Meteor.user().profile.btcAddress) &&
                            //    (jsonTransaction['to'] == currentGame.gameBTCAddress) &&
                            //    (jsonTransaction['amount']['amount'] == currentGame.btcAmount)){
                            //        if (isPlayerOne) {
                ...
                cl('counter: ' + counter);
                if (counter > 5) {
                    cl("Cleared intervalId but only because it timed out after 10 seconds");
                    Meteor.clearInterval(intervalId);
                }
                ...
                if (counter == 1) {
                    ...
                    cl('Cleared IntervalId after player updated');
                    Meteor.clearInterval(intervalId);
                }
            }, 2000);
            cl('BTCHasClearedForPlayer1() method returns with no value.');
        }
    })
}
